...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
        ...
        if visual_attention_mask is not None:
            ...
            extended_visual_attention_mask = extended_visual_attention_mask.to(dtype=torch.float32) # fp16 compatibility
...
class LXRTPretraining(BertPreTrainedModel):
    def __init__(self,
        ...
        if self.task_mrfr:
            self.obj_predict_head = BertVisualObjHead(config, self.bert.encoder.visn_fc.visn_fc.weight)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
        ...
        (lang_output, visn_output), pooled_output = self.bert(
            ...
            visual_feats=visual_feats, visual_attention_mask=visual_mask
        )
