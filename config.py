...
def parse_args():
    ...
    parser.add_argument('--raw_ckpt', type=str, default = '/home/zhangjglab01/daoan/WeChat/checkpoint/uniter_Epoch35.pth')
    parser.add_argument('--ckpt_file', type=str, default='/home/zhangjglab01/daoan/WeChat/challenge/save/v1/model_epoch_10_mean_f1_0.6897.bin')
