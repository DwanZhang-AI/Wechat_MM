...
def parse_args():
    ...
    parser.add_argument('--train_unlabel_annotation', type=str, default='data/annotations/unlabeled.json')
    parser.add_argument('--train_unlabel_feats', type=str, default='data/zip_feats/unlabeled.zip')

    # parser.add_argument('--bert_dir', type=str, default='/home/zhangjglab01/daoan/WeChat/checkpoint/uniter_Epoch35.pth')

    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/v3')
    parser.add_argument('--raw_ckpt', type=str, default = '/home/zhangjglab01/daoan/WeChat/checkpoint/title_asr_ocr_Epoch39.pth')
    parser.add_argument('--ckpt_file', type=str, default='/home/zhangjglab01/daoan/WeChat/challenge/save/v3/model_epoch_13_mean_f1_0.9966.bin')
