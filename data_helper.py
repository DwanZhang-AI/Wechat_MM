...
def create_dataloaders(args):
    ...
    #
    unlabel_dataset = MultiModalDataset(args, args.train_unlabel_annotation, args.train_unlabel_feats, unlabel_mode = True)
    ...
    train_dataloader = dataloader_class(train_dataset,
                                        ...
                                        drop_last=True)
    unlabel_dataloader = dataloader_class(unlabel_dataset,
                                        batch_size=args.batch_size,
    ...
    val_dataloader = dataloader_class(val_dataset,
                                      ...
                                      sampler=val_sampler,
                                      drop_last=False)
    return train_dataloader, val_dataloader, unlabel_dataloader
...
class MultiModalDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 unlabel_mode: bool = False):
        self.max_frame = args.max_frames
        self.bert_seq_length = args.bert_seq_length
        self.test_mode = test_mode
        self.unlabel_mode = unlabel_mode
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        if not self.test_mode and not self.unlabel_mode:
            # print(self.unlabel_mode)
